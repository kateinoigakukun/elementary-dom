...
extension Never: HTMLTagDefinition {
    ...
    public static var _rendersInline: Bool { false }
}
...
extension _RenderingContext {
    @usableFromInline
    func assertNoAttributes(_ element: Any) {
        // Stub implementation - removed server-side rendering assertion
    }

    @usableFromInline
    func assertionFailureNoAsyncContext(_ element: Any) {
        // Stub implementation - removed server-side rendering assertion
    }
}
