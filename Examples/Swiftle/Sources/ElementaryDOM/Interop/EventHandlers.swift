...
public extension View {
    func onKeyDown(_ handler: @escaping () -> Void) -> _EventHandlingView<Self> {
        on("keydown", handler: handler)
    }
    ...
    func onInput(_ handler: @escaping () -> Void) -> _EventHandlingView<Self> {
        on("input", handler: handler)
    }
}
